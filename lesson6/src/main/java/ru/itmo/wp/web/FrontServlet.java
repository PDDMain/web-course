...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        Method beforeMethod = getMethod(route.getBefore(), pageClass);
        Method actionMethod = getMethod(route.getAction(), pageClass);
        Method afterMethod = getMethod(route.getAfter(), pageClass);
    ...
    private Method getMethod(String action, Class<?> pageClass) throws NotFoundException {
        Method method = null;
